...
## V2.6.1 — Verified District Tourism Explorer
- สร้างใหม่จาก V2.5.2 ไม่ใช้รายการท่องเที่ยวจาก V2.6 เดิม
- แผนที่ Hover แสดงประชากร พื้นที่ ตำบล หมู่บ้าน และจำนวนบ้าน
- Click/Tap เปิดหน้าแยก 6 อำเภอ
- ใส่เฉพาะสถานที่ที่ตรวจสอบได้จากหน่วยงานทางการและมีแหล่งอ้างอิง
- ทุกสถานที่มีลิงก์ “แหล่งข้อมูล” กลับไปยังหน่วยงานต้นทาง
- ไม่ใส่สถานที่ที่ยังยืนยันอำเภอ/จังหวัดไม่ได้
